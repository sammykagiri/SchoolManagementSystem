...
urlpatterns = [
    ...
    path('emails/<str:email_id>/', views.email_detail, name='email_detail'),
    
    # SMS messages
    path('sms/', views.sms_list, name='sms_list'),
    path('sms/<str:sms_id>/', views.sms_detail, name='sms_detail'),
    
    # Communication logs
    path('logs/', views.communication_log_list, name='log_list'),
    path('logs/<str:log_id>/', views.communication_log_detail, name='log_detail'),
    
    # Send communications (use student tokens)
    path('send/email/<str:student_id>/', views.send_email, name='send_email'),
    path('send/sms/<str:student_id>/', views.send_sms, name='send_sms'),
    
    # API endpoints
    path('api/template/<str:template_id>/', views.get_template_content, name='get_template_content'),
